$(function () {
    $('#data').DataTable({
        ...
        columns: [
            { "data": "id"},
            { "data": "name"}, //Nombres de los atributos de mis tablas (objeto diccionario)
            { "data": "desc"}, 
            { "data": "desc"}, // se refiere a la columna de mas donde estan los botones
        ],
        //Personalizo las columnas que voy creando
        columnDefs: [
            {
                targets: [3],
                class: 'text-center',
